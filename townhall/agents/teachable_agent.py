...
from townhall.agents.utils import colored, is_termination_msg
...
class TeachableAgent(ConversableAgent):
        ...
        **kwargs,
        ...
        Args:
            ...
            teach_config (dict or None): Additional parameters used by TeachableAgent.
                ...
                - path_to_db_dir (Optional, str): path to the directory where the DB is stored. Default "./.cache/teachable_agent_db"
        ...
        self.path_to_db_dir = self._teach_config.get("path_to_db_dir", "./.cache/teachable_agent_db")
    ...
    def _generate_teachable_assistant_reply(
        ...
        # Generate a response.
        print(colored("\nGENERATING A RESPONSE", "light_yellow"))
